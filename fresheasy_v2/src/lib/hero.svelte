<div class="bg-[url('/assets/banner_background.png')] bg-center w-full flex xl:pt-16 h-4/5">
    <div class="text-center md:w-3/5 w-full md:pl-16 pb-16 mt-24">
        ...
        <a href="./mealkits.html"><div class="btn bg-primary-500 text-black hover:scale-105">ORDER NOW</div></a>
    </div>
    <div class="w-2/5 pr-16 hidden md:block overflow-visible mt-24">
        <img src="assets/banner_img.png" alt="" class="w-full pb-16"/>
    </div>
</div>
...
<nav class="bg-white z-50  px-3 sm:px-3 md:px-3 lg:p-1 xl:p-1 2xl:p-1 fixed w-screen shadow-xl select-none">
  <div class="container mx-auto px-4 py-2 flex justify-between items-center">
    ...
    <ul class="hidden lg:flex space-x-10">
      <li class="flex content-center justify-center"><a href="home.html" class="text-black hover:text-yellow-500 duration-150 text-xl px-2 pt-1">Home</a></li>
      <li class="flex content-center justify-center"><a href="about.html" class="text-black hover:text-yellow-500 duration-150 text-xl px-2 pt-1">About</a></li>
      <li>
        <div class="flex relative pt-1">
          <a href="mealkits.html" class="text-black hover:text-yellow-500 duration-150 text-xl px-2">Mealkits</a>
          ...
          <div class="cursor-pointer pt-1.5 relative">
            ...
            {#if isDropdownOpen}
              <ul class="py-4 bg-white text-black rounded-lg text-center absolute -top-6 mt-16 -left-14 w-max shadow-xl">
                <a href="beef.html"><li class="px-4 py-1 text-xl hover:bg-gray-200">Beef Bulgogi</li></a>
                <a href="chicken.html"><li class="px-4 py-1 text-xl hover:bg-gray-200">Spicy Chicken Bulgogi</li></a>
                <a href="pork.html"><li class="px-4 py-1 text-xl hover:bg-gray-200">Spicy Pork Bulgogi</li></a>
                <a href="armystew.html"><li class="px-4 py-1 text-xl hover:bg-gray-200">Army Stew</li></a>
              </ul>
            {/if}
          </div>
        </li>
        <li class="flex content-center justify-center"><a href="faq.html" class="text-black hover:text-yellow-500 duration-150 text-xl px-2 pt-1">FAQ</a></li>
        <li class="flex content-center justify-center"><a href="contact.html" class="text-black hover:text-yellow-500 duration-150 text-xl px-2 pt-1">Contact Us</a></li>
        <li class="pt-1">
          <div class="relative">
            <!-- svelte-ignore a11y-no-static-element-interactions -->
            <!-- svelte-ignore a11y-click-events-have-key-events -->
            ...
            <div class="px-2 py-3 mt-4 bg-white text-black rounded-lg text-center right-0 absolute w-max shadow-xl" on:blur={cartBlur}>
              ...
              <div class="w-max flex justify-between">
                ...
                <a class="mt-2 py-1 px-2 flex items-center font-bold bg-primary-500 rounded-xl" href="checkout.html">Check Out &nbsp;<svg class="" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z"/></svg> </a>
              </div>
            </div>
            {/if}
          </div>
  ...
  <div class="lg:hidden absolute top-20 z-50 shadown-xl w-screen border-b-4 border-gray-300">
    <ul class="bg-white z-50 py-4">
      <li class="py-1"><a href="home.html" class="block text-black hover:bg-gray-200 duration-150 pl-4 py-2 text-xl w-full">Home</a></li>
      <li class="py-1"><a href="about.html" class="block text-black hover:bg-gray-200 duration-150 pl-4 py-2 text-xl">About</a></li>
      <li class="py-1"><a href="faq.html" class="block text-black hover:bg-gray-200 duration-150 pl-4 py-2 text-xl">FAQ</a></li>
      <li class="py-1"><a href="contact.html" class="block text-black hover:bg-gray-200 duration-150 pl-4 py-2 text-xl">Contact Us</a></li>
      <li class="py-1"><a href="checkout.html" class="block text-black hover:bg-gray-200 duration-150 pl-4 py-2 text-xl">

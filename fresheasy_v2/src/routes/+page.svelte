...
<script>
	...
	import ProductSelector from '$lib/product_selector.svelte';
</script>
	...
	<div class="mx-auto flex justify-center items-center">
		<div class="bg-white w-screen py-8">
			...
			<div class="bg-[url('/assets/banner_background.png')] w-full h-4/5 py-12">
				...
				<div class="">
					<ul class="px-8 sm:px-24 md:px-36 lg:px-48 xl:px-96">
						<li class="py-6">
							<div class="flex">
								<div class="md:w-3/12 flex float-right justify-center lg:pl-6">
									<svg class="scale-75 md:scale-100" xmlns="http://www.w3.org/2000/svg" height="6em" viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M464 256A208 208 0 1 1 48 256a208 208 0 1 1 416 0zM0 256a256 256 0 1 0 512 0A256 256 0 1 0 0 256zM232 120V256c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2V120c0-13.3-10.7-24-24-24s-24 10.7-24 24z"/></svg>
								</div>
								<div class="w-8/12 md:w-9/12 pl-2">
									<h4 class="h4 font-bold pt-4">Save Time</h4>
									<p class="">Skip trips to the supermarket</p>
								</div>
							</div>
						</li>
						<li class="py-6">
							<div class="flex">
								<div class="md:w-3/12 flex justify-center lg:pl-6">
								...
								<div class="w-8/12 md:w-9/12 pl-2">
									<h4 class="h4 font-bold pt-4">Save Money</h4>
									<p class="">Enjoy tasty and affordable meals, at less than $10 per meal</p>
								</div>
							</div>
						</li>
						<li class="py-6">
							<div class="flex">
									<div class="md:w-3/12 flex float-right justify-center lg:pl-6">
										<svg class="scale-75 md:scale-100" xmlns="http://www.w3.org/2000/svg" height="6em" viewBox="0 0 576 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M240 144A96 96 0 1 0 48 144a96 96 0 1 0 192 0zm44.4 32C269.9 240.1 212.5 288 144 288C64.5 288 0 223.5 0 144S64.5 0 144 0c68.5 0 125.9 47.9 140.4 112h71.8c8.8-9.8 21.6-16 35.8-16H496c26.5 0 48 21.5 48 48s-21.5 48-48 48H392c-14.2 0-27-6.2-35.8-16H284.4zM144 80a64 64 0 1 1 0 128 64 64 0 1 1 0-128zM400 240c13.3 0 24 10.7 24 24v8h96c13.3 0 24 10.7 24 24s-10.7 24-24 24H280c-13.3 0-24-10.7-24-24s10.7-24 24-24h96v-8c0-13.3 10.7-24 24-24zM288 464V352H512V464c0 26.5-21.5 48-48 48H336c-26.5 0-48-21.5-48-48zM48 320h80 16 32c26.5 0 48 21.5 48 48s-21.5 48-48 48H160c0 17.7-14.3 32-32 32H64c-17.7 0-32-14.3-32-32V336c0-8.8 7.2-16 16-16zm128 64c8.8 0 16-7.2 16-16s-7.2-16-16-16H160v32h16zM24 464H200c13.3 0 24 10.7 24 24s-10.7 24-24 24H24c-13.3 0-24-10.7-24-24s10.7-24 24-24z"/></svg>
									</div>
									<div class="w-8/12 md:w-9/12 pl-2">
										<h4 class="h4 font-bold pt-4">Easy to Cook</h4>
										<p class="">Our meal kit recipes have less than 5 steps to follow</p>
								</div>
							</div>
						</li>
					</ul>

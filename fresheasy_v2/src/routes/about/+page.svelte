...
<main class="">
	...
	<div class="flex justify-center align-middle">
		<PageTitle 
			page_title="About Us"
			page_subtitle="Save a <span class='text-primary-600'>trip</span> to Korea with [SL x FRESHEASY] Meal Kits<br>&nbsp;"
			icon_left=' '
	...
	<div class="md:flex md:flex-row-reverse py-12 bg-white">
		...
		<div class="md:w-1/2 flex flex-row-reverse md:flex-col content-center justify-center">
			<div class="w-1/2 md:w-full flex justify-center py-8">
				<img 
					...
					class="-rotate-[10deg] h-48 md:h-64 pb-8 pr-4  md:pb-0 drop-shadow-[-4px_6px_6px_rgba(0,0,0,1)]"
				/>
			</div>
			<div class="w-1/2 md:w-full flex justify-center py-8">
				<img 
					src="./assets/army_stew_img.png" alt=""
					class="rotate-[10deg] h-48 md:h-64 pb-8 pl-4  md:pb-0 drop-shadow-[-4px_6px_6px_rgba(0,0,0,1)]"
				/>
			</div>
		</div>
	</div>
